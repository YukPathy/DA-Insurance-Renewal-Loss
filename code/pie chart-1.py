...
df = pd.read_csv('G:/insurance.csv')
...
labels= ['age', 'sex', 'steps', 'children', 'smoker', 'region', 'charges', 'insuranceclaim']

colors=['blue', 'yellow', 'green', 'orange', 'pink', 'purple', 'white', 'red']

sizes= [1500, 600, 500, 800, 750, 850, 900, 600]
